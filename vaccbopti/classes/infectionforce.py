...
class InfectionForce:
    ...
    def calc_z(self, a, b, num_people=100000):
    ...
    def calc_lambda(self, a, infec_rate_param=params.infec_rate_param, num_people=100000):
        ...
        for b in range(len(params.age_groups)):  # loop to sum z
            sub_z = self.calc_z(a, b=b, num_people=num_people)
    ...
    def all_lambda(self, infec_rate_param=params.infec_rate_param, num_people=100000):
        """Calculates lambda for each age group a, and holds them in a list."""
        for a in range(len(params.age_groups)):
            lambda_a, test_n = self.calc_lambda(a, infec_rate_param, num_people)
